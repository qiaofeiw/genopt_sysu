...
/**
 * The D/m-group Shifted m-dimensional Rosenbrock抯 Function: F18.
 * 
 * @author Thomas Weise
 */
public final class F18 extends ShiftedPermutatedFunction {
  ...
  /**
   * Create a new D/m--group Shifted m-dimensional Rosenbrock抯 Function
   * 
   * @param o
  ...
  public final String getFullName() {
    return "D/m-group Shifted m-dimensional Rosenbrock抯 Function";//$NON-NLS-1$
  }

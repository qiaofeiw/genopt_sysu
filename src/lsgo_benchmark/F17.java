...
/**
 * The D/m-group Shifted m-dimensional Schwefel抯 Problem 1.2: F17.
 * 
 * @author Thomas Weise
 */
public final class F17 extends ShiftedPermutatedFunction {
  ...
  /**
   * Create a new D/m--group Shifted m-dimensional Schwefel抯 Problem 1.2
   * 
   * @param o
  ...
  public final String getFullName() {
    return "D/m-group Shifted m-dimensional Schwefel抯 Problem 1.2";//$NON-NLS-1$
  }

...
/**
 * The Single-group Shifted m-dimensional Schwefel抯 Problem 1.2: F7.
 * 
 * @author Thomas Weise
 */
public final class F7 extends ShiftedPermutatedFunction {
  ...
  /**
   * Create a new Single-group Shifted m-dimensional Schwefel抯 Problem 1.2
   * 
   * @param o
   ...
   * &quot;Benchmark Functions for the CEC�010 Special Session and
  ...
  public final String getFullName() {
    return "Single-group Shifted m-dimensional Schwefel抯 Problem 1.2";//$NON-NLS-1$
  }

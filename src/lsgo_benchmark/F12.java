...
/**
 * The D/2m-group Shifted m-dimensional Schwefel抯 Problem 1.2: F12.
 * 
 * @author Thomas Weise
 */
public final class F12 extends ShiftedPermutatedFunction {
  ...
  /**
   * Create a new D/2m--group Shifted m-dimensional Schwefel抯 Problem 1.2
   * 
   * @param o
  ...
  public final String getFullName() {
    return "D/2m-group Shifted m-dimensional Schwefel抯 Problem 1.2";//$NON-NLS-1$
  }

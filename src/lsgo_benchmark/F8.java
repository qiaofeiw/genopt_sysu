...
/**
 * The Single-group Shifted m-dimensional Rosenbrock抯 Function: F8.
 * 
 * @author Thomas Weise
 */
public final class F8 extends ShiftedPermutatedFunction {
  ...
  /**
   * Create a new Single-group Shifted m-dimensional Rosenbrock抯 Function
   * 
   * @param o
  ...
  public final String getFullName() {
    return "Single-group Shifted m-dimensional Rosenbrock抯 Function";//$NON-NLS-1$
  }
